...
- After you change a `data-gpis-*` attribute, which the `AGENTS.md` attribute table lists.
...
- After you change which motion the extension shortens, which the `README.md` Troubleshooting section walks the user through.
...
| `src/instantSwap/instantSwapStyles.css`                                       | The `AGENTS.md` attribute table, the `README.md` Options table and Troubleshooting section                          |
| `src/instantSwap/mainWorldMotionPatch.js`                                     | `adr/0004-two-content-script-worlds.md`, the `README.md` "The photos still slide" section                           |
| A storage key                                                                 | `adr/0007-extension-storage-layout.md`, the `README.md` Privacy section                                             |
